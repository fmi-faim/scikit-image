...
@pytest.mark.parametrize('chunks', (None, (128, 128), 'ndim'))
@pytest.mark.parametrize('depth', (0, 8, (8, 8)))
...
def test_apply_parallel_rgb_channel_axis(depth, chunks, channel_axis):
    ...
    Can specify scalar depth or a 1 depth per spatial axis.
    Can specify chunks=None or 1 chunk size per spatial axis.
    """
